...
@section('content')
    <section class="container-fluid bg-light d-flex flex-column align-items-center justify-content-center py-5">
        <h1 class="x-text-size-sm fs-3 text-uppercase text-center">{{ $categorie }}</h1>
            ...
            <div class="row">
                ...
                @if (sizeof($products) == 0)
                    <div class="container-fluid py-5 ">
                        ...
                        <div class="text-warning text-center x-text-size-fs6">Retrouvez prochainement les produits de cette
                            catégorie</div>
                    </div>
                @endif
                ...
                @if (sizeof($products) > 0)
                    @foreach ($products as $product)
                        <div class="x-colproducts d-desktop">
