    ...
    <div class="card">
      <div class="card-header bg-transparent">
        <div class="row align-items-center">
            ...
            <div class="col-4 text-right">
                <a href="{{ route('categorie.index')}}" class="btn btn-sm btn-dark">Toute les categories</a>
            </div>
        </div>
      ...
      <div class="card-body">
        ...
        <div class="col-6">
              ...
              <img src="{{ $category->file}}" alt="{{ $category->libelle }}" class="img-fluid">
        </div>
          ...
          <div class="col-6">
              ...
              <p class="font-weight-bold"> <br> {{ $category->description }}</p>
          </div>
