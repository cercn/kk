            ...
            <form action="{{ route('categorie.store')}}" method="POST" enctype="multipart/form-data">     
              ...
              @csrf
                ...
                <div class="form-group">
                                ...
                                <input type="text"  name="nom" id="nom" class="form-control" placeholder="berline">
                            </div>
                            ...
                            <div class="form-group">
                               ...
                               <input type="file" name="file_categorie" accept=".png,.jpg,.jpeg" id="file" class="form-control">
                            </div>
                            ...
                            <div class="form-group">
                               ...
                               <textarea name="desc_categorie" id="desc" class="form-control"></textarea>
                            </div>              
