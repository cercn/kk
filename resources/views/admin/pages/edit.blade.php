...
@section('title', 'Page')
@section('subtitle', 'modifier-une-page')
@section('content')
    <div class="row">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h3 class="mb-0">Modifier une  page </h3>
                        </div>
                             ...
                             <div class="col-md-12 mb-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" class="form-control @error('title') is-invalid @enderror"
                                            placeholder="Tapez votre texte ici" value="{{$page->title}}">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" id="tinymce" cols="30" rows="8" class="form-control @error('description') is-invalid @enderror"
                                            placeholder="Tapez votre texte ici">{{$page->description}}</textarea>
